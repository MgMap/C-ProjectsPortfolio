...
std::string Textures::getPath(textureEnum texture)
{
    switch(texture)
    {
        ...
        case SPLASH: return "pics/Screenshot 2022-12-15 111101.jpg";
        ...
        case ARROW: return "Project pic/ARROW-removebg-preview.png";
        case OPEN_PROJECT: return "pics/open project.png";
    }
}
