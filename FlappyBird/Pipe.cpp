...
void Pipe::spawnPipeDown()
{
    ...
    sprite.setPosition(PORTFOLIO_SCREEN_WIDTH, -pipeSpawnOffSetY);
...
void Pipe::spawnPipeUp()
{
    ...
    sprite.setPosition(PORTFOLIO_SCREEN_WIDTH, PORTFOLIO_SCREEN_HEIGHT -sprite.getGlobalBounds().height - pipeSpawnOffSetY);
    PipeSprites.push_back(sprite);
}
...
void Pipe::spawnScoringPipe()
{
    ...
    rectangleShape.setPosition(PORTFOLIO_SCREEN_WIDTH, 0);
